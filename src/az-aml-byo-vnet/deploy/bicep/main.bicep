...
param vnetAddressPrefix string = '192.168.8.0/22'

@description('Training subnet address prefix')
param trainingSubnetPrefix string = '192.168.9.0/24'

@description('Scoring subnet address prefix')
param scoringSubnetPrefix string = '192.168.10.0/24'

@description('Bastion subnet address prefix')
param azureBastionSubnetPrefix string = '192.168.11.192/27'
